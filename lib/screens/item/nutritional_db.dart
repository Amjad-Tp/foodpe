        ...
        child: ListView(
          ...
          children: [
            ...
            const Padding(
              ...
              child: Text('Show Nutritional Information',style: TextStyle(fontSize: 24,fontWeight: FontWeight.w500),),
            ),
            const Padding(
              padding: EdgeInsets.symmetric(horizontal: 15.0),
              child: Text('(per serving, 2 slices)',style: TextStyle(fontSize: 18),),
            ),
            ...
            _buildNutritionalInformation(
              itemText: "Calories :",
              valueText: foodRecipe.calories
            ),

            //--------protien
            _buildNutritionalInformation(
              itemText: "Protein :",
              valueText: foodRecipe.protein
            ),
            //--------carbhohydrates
            _buildNutritionalInformation(
      ...
      child: Column(
        children: [
          Row(
            ...
            children: [
              Text(itemText,style: const TextStyle(fontSize: 22,fontWeight: FontWeight.w500),),
              Text(valueText,style: const TextStyle(fontSize: 22,fontWeight: FontWeight.w500),),
            ],
          )
        ],
      ),
