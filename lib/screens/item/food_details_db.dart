    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 15),
          Text(widget.foodRecipe.preparation,
            style: const TextStyle(fontSize: 20),
          ),
          const SizedBox(height: 15),
          TextButton(
      ...
      children: [
        if (widget.foodRecipe.foodImagePath != null)
          kIsWeb
              ...
              : Image.file(File(widget.foodRecipe.foodImagePath!),
                  fit: BoxFit.cover,
                ),
        Container(
        ...
        Positioned(
          ...
          child: IconButton(
            ...
            icon: Icon(
              widget.foodRecipe.isCollected? Icons.bookmark_rounded : Icons.bookmark_outline_rounded,
              size: 35,
              color: Colors.white,
            ),
          )
