...
class CollectionsScreen extends StatelessWidget {
  ...
  Future<void> collectionRemoveConfirmation(
      BuildContext context, Food foodRecipe) async {
    ...
    showDialog(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          content: Text(
            "Are sure to remove '${foodRecipe.title}' ?",
