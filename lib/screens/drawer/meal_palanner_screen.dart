            ...
            Expanded(
              child: ValueListenableBuilder(
                ...
                builder: (context, Box<MealPlannerModel> box, _) {
                  ...
                  final Map<String, Map<String, MealPlannerModel?>> groupedMeals = {};
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              onPressed: () {
                final mealKey = mealBox.toMap().entries
                    .firstWhere(
                      (entry) => entry.value.day == meal.day && entry.value.category == meal.category,
                    )
                    .key;
